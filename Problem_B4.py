...
def solution_B4():
    ...
    text_bbc, category_bbc = bbc['text'], bbc['category']
    ...
    # YOUR CODE HERE
    training_sentences, testing_sentences, training_labels, testing_labels = train_test_split(text_bbc, category_bbc, train_size=training_portion, shuffle=False)
    ...
    label_tokenizer.fit_on_texts(category_bbc)

    training_label_sequences = np.array(label_tokenizer.texts_to_sequences(training_labels))
    testing_label_sequences = np.array(label_tokenizer.texts_to_sequences(testing_labels))
    ...
    model.fit(padded,
              ...
              epochs=50,
              validation_data=(testing_padded, testing_label_sequences),
              verbose=2
              )
